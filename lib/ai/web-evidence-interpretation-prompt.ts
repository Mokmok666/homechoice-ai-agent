...
const DIMENSION_CONTRACTS = {
  ...
  property_management: {
    ...
    relevant: "明确物业公司、项目级物业信息、服务范围或费用、实际服务记录、可信投诉或住户反馈、与项目明确相关的服务荣誉。",
    prohibited: "住宅/商业物业类型、建筑类型、开发商、产权类型和项目定位不是物业服务质量证据。",
  },
  ...
  value_preservation: {
    question: "是否存在能够支撑长期价值稳定的结构性因素？",
    relevant: "已建成交通和商业、稳定产业就业或需求、供给条件、已交付公共设施及可靠流动性等长期基本面。",
    prohibited: "绿化率、板楼/塔楼、高层分类、景观、单个未来规划和营销描述不能单独推出保值能力。",
  },
} as const;
