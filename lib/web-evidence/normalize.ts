  ...
  switch (dimensionKey) {
    ...
    case "education":
      return verified
        ...
        : "现有公开资料仅提供部分学校关联线索，尚不足以确认招生范围或入学资格。";
    ...
    case "liquidity":
      return verified
        ? "公开资料包含真实成交活动线索，但样本与周期信息仍有限，流动性只能谨慎判断。"
        : "现有公开资料主要是挂牌或零散成交线索，尚不足以判断实际转售流动性。";
    case "value_preservation":
      return verified
        ? "公开资料提供了部分已建成交通、产业或需求支撑线索；长期价值仍由确定性结构评分派生。"
        : "现有资料多为区域线索，单一规划或营销信息不能形成长期保值判断。";
  }
}
