...
export const DECISION_FRAMEWORK: readonly DecisionDimensionFramework[] = [
  ...
  { key: "commercial_amenities", label: "商业配套", group: "location_and_family", definition: "两公里内大型商场、购物中心和商业综合体的可达性。", decisionQuestion: "大型集中商业设施是否便于到达？", scoringMode: "deterministic", preferredEvidence: ["高德大型商业体分类", "最近商业体距离", "两公里内有效商业体数量"], weakEvidence: ["便利店、超市、餐饮等生活POI", "规划商业", "重复POI"], missingBehavior: "外部请求失败时保持未知。", baseWeight: 5, dimensionType: "ai" },
