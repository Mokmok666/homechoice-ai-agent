...
export const DECISION_FRAMEWORK: readonly DecisionDimensionFramework[] = [
  ...
  { key: "commute", label: "通勤匹配", group: "location_and_family", definition: "真实路线时间与家庭理想及最大通勤边界的匹配程度。", decisionQuestion: "家庭成员的真实通勤是否处于各自可接受范围？", scoringMode: "deterministic", preferredEvidence: ["高德路线时长", "本人和伴侣通勤阈值"], weakEvidence: ["直线距离", "主观估计"], missingBehavior: "路线缺失时保持未知或部分证据，不按零分处理。", baseWeight: 9, dimensionType: "preference" },
  { key: "public_transport", label: "公共交通便利度", group: "location_and_family", definition: "步行可达地铁与周边公交覆盖共同形成的日常公共交通能力。", decisionQuestion: "不依赖驾车时，地铁或公交是否足以支持日常出行？", scoringMode: "hybrid", preferredEvidence: ["最近地铁直线距离", "最近公交站距离", "500米和800米公交站覆盖"], weakEvidence: ["远距离地铁存在", "缺失公交数据"], missingBehavior: "公交证据缺失不等于无公交；远地铁且公交未知时不生成低分。", baseWeight: 5, dimensionType: "fact" },
  { key: "commercial_amenities", label: "商业配套", group: "location_and_family", definition: "两公里内大型商场、购物中心和商业综合体的可达性。", decisionQuestion: "大型集中商业设施是否便于到达？", scoringMode: "deterministic", preferredEvidence: ["高德大型商业体分类", "最近商业体距离", "两公里内有效商业体数量"], weakEvidence: ["便利店、超市、餐饮等生活POI", "规划商业", "重复POI"], missingBehavior: "外部请求失败时保持未知。", baseWeight: 6, dimensionType: "ai" },
  { key: "education", label: "教育需求", group: "location_and_family", definition: "房源与家庭当前或未来教育需求之间经官方政策支持的关系。", decisionQuestion: "是否有当前有效的官方证据连接房源、招生范围与家庭教育阶段？", scoringMode: "hybrid", preferredEvidence: ["官方招生政策", "官方服务范围", "当前有效的项目学校关系"], weakEvidence: ["附近有名校", "学区房营销", "直线距离"], missingBehavior: "未核验学校关系不扣分；无教育需求时不参与评分。", baseWeight: 5, dimensionType: "preference" },
  { key: "medical_amenities", label: "医疗配套", group: "location_and_family", definition: "三公里内正规综合医院、公立医院及明确医院类设施的可达性。", decisionQuestion: "家庭能否方便到达正规的医院类医疗设施？", scoringMode: "deterministic", preferredEvidence: ["高德医院结构化分类", "最近正规医院距离", "三公里内医院数量"], weakEvidence: ["药店、诊所、牙科、医美、保健及养老机构", "未经证实的医院等级"], missingBehavior: "外部请求失败时保持未知，不把缺失视为零。", baseWeight: 4, dimensionType: "ai" },
  { key: "layout_design", label: "户型设计", group: "home_and_living", definition: "房间、厅卫及功能空间结构的可用性。", decisionQuestion: "户型结构是否支持家庭的实际使用方式？", scoringMode: "deterministic", preferredEvidence: ["结构化室厅卫", "户型图"], weakEvidence: ["营销户型名称"], missingBehavior: "只有户型字符串时可记录，证据不足不强行评分。", baseWeight: 9, dimensionType: "fact" },
  ...
  { key: "community_quality", label: "小区品质", group: "home_and_living", definition: "社区公共空间、维护、密度与实际居住体验。", decisionQuestion: "项目本身是否具有可验证的稳定居住品质？", scoringMode: "hybrid", preferredEvidence: ["项目级交付与维护记录", "可信社区环境资料"], weakEvidence: ["开发商品牌", "高端定位"], missingBehavior: "项目介绍不能单独形成品质分。", baseWeight: 8, dimensionType: "ai" },
  { key: "property_management", label: "物业服务", group: "home_and_living", definition: "项目实际物业服务、维护与响应表现。", decisionQuestion: "该项目的日常物业服务是否有可信的项目级证据支持？", scoringMode: "hybrid", preferredEvidence: ["项目级服务记录", "维护与投诉记录", "可信住户体验"], weakEvidence: ["物业公司名称", "开发商品牌", "头部物业营销"], missingBehavior: "仅知道管理公司时只记录事实，分数保持未知。", baseWeight: 6, dimensionType: "fact" },
  ...
  { key: "transaction_price_reasonableness", label: "成交价合理性", group: "price_and_margin", definition: "预期成交单价与近期同类已确认成交样本的关系。", decisionQuestion: "预期成交价是否得到足够近期可比成交支持？", scoringMode: "hybrid", preferredEvidence: ["至少3条近24个月已确认可比成交"], weakEvidence: ["挂牌价", "营销报价", "单条成交线索"], missingBehavior: "样本不足时保持部分证据且分数为空。", baseWeight: 7, dimensionType: "fact" },
  { key: "liquidity", label: "流动性", group: "long_term_value", definition: "房源未来再次交易时的实际成交活跃度与受众宽度。", decisionQuestion: "这类房源是否有真实、持续的成交需求？", scoringMode: "hybrid", preferredEvidence: ["真实成交频率", "成交周期", "主流面积和总价带"], weakEvidence: ["单条挂牌", "只有挂牌数量"], missingBehavior: "缺少成交活动证据时保持未知或部分证据。", baseWeight: 5, dimensionType: "ai" },
